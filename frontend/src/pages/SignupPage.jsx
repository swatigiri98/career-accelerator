...
function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-paper-50 px-4 py-10 dark:bg-ink-950">
      <Card className="w-full max-w-sm p-8">
        ...
        <h1 className="mb-1 text-2xl font-bold text-paper-900 dark:text-ink-50">Create your account</h1>
        <p className="mb-6 text-sm text-paper-600 dark:text-ink-200">
          Start with a resume upload and get your first Career Score in minutes.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="mb-1.5 block text-sm font-medium text-paper-900 dark:text-ink-50">
              Full name
            </label>
            <input
              id="name"
          ...
          <div>
            ...
            >
              Target role <span className="text-paper-600 dark:text-ink-200">(optional)</span>
            </label>
            <input
              id="targetRole"
              name="targetRole"
